...
RSpec.describe String do
  [
    ...
    { method: :grey, expected_output: "\e[37mTest String\e[0m" },
    { method: :bright_black, expected_output: "\e[90mTest String\e[0m" },
    { method: :bright_red, expected_output: "\e[91mTest String\e[0m" },
    { method: :bright_green, expected_output: "\e[92mTest String\e[0m" },
    { method: :bright_yellow, expected_output: "\e[93mTest String\e[0m" },
    { method: :bright_blue, expected_output: "\e[94mTest String\e[0m" },
    { method: :bright_magenta, expected_output: "\e[95mTest String\e[0m" },
    { method: :bright_cyan, expected_output: "\e[96mTest String\e[0m" },
    { method: :white, expected_output: "\e[97mTest String\e[0m" },
